<script>
    ...
    $('#createNewItem').click(function() {
        ...
        $('#modalTitle').html("Ajouter nouvelle unite");
    ...
    $(document).on('click', '.edit-item', function() {
        ...
        $.get(`unites/${id}`, function(data) {
            console.log(data);
            $('#error-unite').html('');
            $('#modalTitle').html("Modifier unite");
    ...
    $('#itemForm').submit(function(e) {
        ...
        const id = $('#id').val();
        const url = id ? `unites/${id}` : '/unites';
        const method = id ? 'PUT' : 'POST';
        const message = id ? 'Unite modifiée avec succès' : 'Unite crée avec succès';
    ...
    $(document).ready(function() {
        $('#itemsTable').DataTable({
            ...
            "ajax": "{{ route('unites.data') }}", // Your data endpoint
