<script>
    ...
    $(document).on('click', '.edit-item', function() {
        ...
        $.get(`etats/${id}`, function(data) {
            console.log(data);
            $('#error-etat').html('');
            $('#modalTitle').html("Modifier Etat");
    ...
    $('#itemForm').submit(function(e) {
        ...
        const id = $('#id').val();
        const url = id ? `etats/${id}` : '/etats';
        const method = id ? 'PUT' : 'POST';
        const message = id ? 'Etat modifiée avec succès' : 'Etat crée avec succès';
    ...
    $(document).ready(function() {
        $('#itemsTable').DataTable({
            ...
            "ajax": "{{ route('etats.data') }}", // Your data endpoint
